...
################################################################################
# 设定
picture_folder = 'picture/1.Analysis/5.0_Sideband_of_omega'
tree = 'fit4c'
branch = 'omega_m'
################################################################################
...
def plot(energy=0,
    ...
    nameh = {}
    # 初始化数据
    selecters['omega_m'].set_width_show(0.25)
    selecters['omega_m'].inter = 50
    ...
    namef['r'], nameh['r'] = alldata.hist(data='real',
                                          branchs=[branch],
                                          docuts=['chisq', 'pi01_m', 'pi02_m', 'pi03_m'],
                                          name='real')
    ...
    momegamass = selecters['omega_m'].center
    drawlist = hstyle.add_arrow(drawlist,
                                momegamass - 0.05, 0,
                                momegamass - 0.05, 0.75 * hr,
                                2, 3)
    drawlist = hstyle.add_arrow(drawlist,
                                momegamass + 0.05, 0,
                                momegamass + 0.05, 0.75 * hr,
