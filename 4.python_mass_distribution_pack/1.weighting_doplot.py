...
if(sys.argv[1] == '-1'):
    os.system('mkdir picture/3.Mass_Distribution/%s' % (option2))
    for i in energy_sort:
        plot(energy=i,
             tree='fit4c',
             branch=option3,
             pictures=['picture/3.Mass_Distribution/%s/%05d.pdf' % (option2, 10000 * i),
                       'picture/3.Mass_Distribution/%s/%05d.jpg' % (option2, 10000 * i)],
             stop='')
