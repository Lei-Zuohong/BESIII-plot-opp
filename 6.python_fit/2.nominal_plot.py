...
parameter_npdf2 = hstatis.PARAMETER(name='npdf2', value=50.0, error=1.0, limitl=0.0, limitr=10000.0)
...
output = {}
for energy in hopp.energy_sort():
    ...
    argv['selecters'] = hopp.selecters()
    argv['selecters']['omega_m'].set_width(0.15)
    argv['selecters']['omega_m'].set_width_show(0.15)
    argv['branch'] = 'omega_m'
    argv['pictures'] = []
    # 设定fit参数
    argv['spread_times'] = 1
    ...
    argv['pictures'] = ['picture/6.Fit_Result/6.1.Fit_Result/%05d.jpg' % (10000 * energy),
                        'picture/6.Fit_Result/6.1.Fit_Result/%05d.pdf' % (10000 * energy)]
    argv['picture_xtitle'], argv['picture_ytitle'] = argv['selecters']['omega_m'].get_title()
    argv['picture_stop'] = ''
