...
# Public package
# Private package
branchs_common = ['pip_m', 'pip_p', 'pip_a',  # 'pip_pe', 'pip_px', 'pip_py', 'pip_pz',
...
branchs_truth = branchs_common + ['is_isr']

branchs_fit4c = branchs_common + ['chisq',
                                  'fpi12_m',
                                  'fpi13_m',
                                  'fpi23_m', ]

branchs_fit4c_truth = branchs_fit4c + ['t_is_isr']
